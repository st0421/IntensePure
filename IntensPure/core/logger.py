    ...
    def save_images(self, results):
        ...
        try:
            ...
            for i in range(len(names)): 
                # print(names[i], type(outputs[i]), outputs[i].shape, result_path)

                # o = torch.tensor(outputs[i])
                # test_save_dir = '/data/Palette-Image-to-Image-Diffusion-Models/abc'
                # save_image(o, os.path.join(test_save_dir, names[i]), normalize=True)
