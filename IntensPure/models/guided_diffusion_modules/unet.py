...
class UNet(nn.Module):
    ...
    def __init__(
        ...
        self.input_blocks = nn.ModuleList(
            [EmbedSequential(nn.Conv2d(in_channel, ch, kernel_size=(kernel_size_row, kernel_size_column), padding=(kernel_size_row//2, kernel_size_column//2)))]
        )
        ...
        self.out = nn.Sequential(
            normalization(ch),
            SiLU(),
            # zero_module(nn.Conv2d(input_ch, out_channel, kernel_size=3, padding=1)),
            zero_module(nn.Conv2d(input_ch, out_channel, kernel_size=(kernel_size_row, kernel_size_column), padding=(kernel_size_row//2, kernel_size_column//2))),
        )
